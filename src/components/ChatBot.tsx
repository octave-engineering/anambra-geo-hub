...
//           className="fixed bottom-6 left-6 h-14 w-14 rounded-full bg-anambra-500 hover:bg-anambra-700 shadow-lg z-50 p-0"
//           size="icon"
//         >
...
//       {/* Chat Window */}
//       {isOpen && (
//         <Card className="fixed bottom-6 left-6 w-96 h-[500px] bg-background border shadow-2xl z-50 flex flex-col">
//           {/* Header */}
//           <div className="flex items-center justify-between p-4 border-b bg-anambra-500 text-white rounded-t-lg">
//             <div className="flex items-center gap-2">
//               <MessageCircle className="h-5 w-5" />
//               <h3 className="font-semibold">Anambra GeoHub Assistant</h3>
//             </div>
//             <Button
...
//           {/* ✅ Quick Suggestions only show if it's the first message */}
//           {messages.length === 1 && (
